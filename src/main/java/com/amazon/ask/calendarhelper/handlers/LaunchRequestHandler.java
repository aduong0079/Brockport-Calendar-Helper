...
public class LaunchRequestHandler implements RequestHandler {
    ...
    public Optional<Response> handle(HandlerInput input) {
        ...
        String title = "Brockport Calendar Helper";
        String primaryText = "Welcome to Brockport Calendar Helper.";
        String secondaryText = "Welcome to Brockport Calendar Helper. What event or date do you need help with?";
        String speechText = "What event or date do you need help with?";

        String imageUrl = "https://d2brwuimzb4ax4.cloudfront.net/schools/196121/logo/large.png";
